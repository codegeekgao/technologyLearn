...
/**
 * @author codegeekgao
 * @version Id: CalPriceFactory.java, v 0.1 2018/12/26 0026 17:46 codegeekgao Exp $$
 */
public class CalPriceFactory {

    private static final String CAL_PRICE_PACKAGE = "com.codegeekgao.designModel.strategy";//这里是一个常量，表示我们扫描策略的包
